     ...
     ; (IERROR   ,IFmt     ,INPWR    ,IOEQT    ,IOFLSAT  ,IOTRS
     ; ,IOWAR    ,IPROB    ,IUGRID   ,LDARR    ,LDARRT   ,LDCOE
     ; ,LDCRD    ,LDDFM    ,LDDSP    ,LDFOD    ,LDPOR    ,LDSTG
     ; ,LDTRA    ,MAINF    ,NROW     ,NUMEL
     ; ,NZARR    ,NZCOE    ,NZCRD    ,NZDFM    ,NZDSP    ,NZFOD
     ; ,NZPOR    ,NZSTG    ,NZTRA    ,FILENAME ,LDIM     ,LTYPE
...
********************************************************************************
       ...
       CHARACTER*100 LEEL,LEAUX
       Character::FILENAME*20,strFmt*20  
...
C------------------------- Card B3.3
          ...
          strFmt = ''
          Write(strFmt,*) 4+IFmt
          strFmt = '(I' //Trim(AdjustL(strFmt))//',10I5)'
          LEAUX=LEEL(FILENAME,IUGRID,MAINF,NROW,INPWR)
          READ(LEAUX,strFmt,ERR=9200) NE,LTRA,LSTG,LARR,
     ;        LARRT,LDSP,LDFM,LPOR,LCRD,LCOE,LFOD
C 1005     FORMAT(I<4+IFmt>,10I5)
...
C------------------------- missing elements
     ...
     ; (IFmt     ,INPWR    ,IOEQT    ,IOFLSAT  ,IOTRS    ,LDARR
     ; ,LDARRT   ,LDCOE    ,LDCRD    ,LDDFM    ,LDDSP    ,LDFOD
     ; ,LDPOR    ,LDSTG    ,LDTRA    ,MAINF    ,N        ,NE
     ; ,NOLD     ,NUMEL    ,NZARR    ,NZCOE    ,NZCRD    ,NZDFM
     ; ,NZDSP    ,NZFOD    ,NZPOR    ,NZSTG    ,NZTRA    ,LDIM
     ; ,LTYPE    ,LXARR    ,LXARRT   ,LXCOE    ,LXCRD    ,LXDFM
     ; ,LXDSP    ,LXFOD    ,LXPOR    ,LXSTG    ,LXTRA)
