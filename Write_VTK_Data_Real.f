      Subroutine Write_VTK_Data_Real
...
C------------------------- External
      ...
      Real*8::Values(IDimVals,NumVals)
...
C-------------------------
   ...
   20     Format('SCALARS',1X,A2,1X,'double ',1X,'1')
   ...
   22     Format('VECTORS',1X,A2,1X,'double ')
      ...
      strFmt1 = '('//Trim(AdjustL(strFmt1))//'(G20.8E3,1X))'
...
C   31			Format (<IDimVals>(G20.8E3,1X))
      ...
      End Subroutine Write_VTK_Data_Real
