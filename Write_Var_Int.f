...
C------------------------- External
      ...
      Integer*4::GridType ,IDimVals ,IOWri1D  ,ITime    ,LMXNDL
     &          ,NUMEL    ,NUMNP    ,NumVals  ,VarType
...
C------------------------- Internal
      ...
      Character::Ext*3,Filename*40,Suffix*7,Title*80

      Integer*4,Allocatable::NewValues(:,:)
