...
*      Input values are VARZ1, etc. they are checked and reassigned if that's
*      necessary
*
* DESCRIPTION
*
...
C_______________________         to be under transient conditions
     ...
     ;       NROW,6,IUPAR,1,ERNUM+0.02)
       ...
       ELSE IF (IOPBLI.EQ.0 .AND. NFNLVAR1.NE.0) THEN
           CALL ERROR(IERROR,IOWAR,MAINF,FILENAME,
     ;     ' LINEAR FLOW DEFINED AND NON LINEAR FUNCTION IS NOT ZERO '//
     ;     ' AT ('//VAR//')',NROW,6,IUPAR,0,ERNUM+0.03)
       ENDIF
