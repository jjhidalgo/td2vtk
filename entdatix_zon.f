     ...
     ; ,INPWR    ,INQQP    ,INQQPT   ,IOEQT    ,IORTS    ,IOTRS
...
********************************************************************************
       ...
       CHARACTER*100 LEEL,LEAUX,FILENAME*20,strFmt*20
...
*_______________________Card B1.3
          ...
          Write(strFmt,*)4+IFmt
          strFmt = '(I'//Trim(AdjustL(strFmt))//',12I5)'

          LEAUX=LEEL(FILENAME,IUGRID,MAINF,NROW,INPWR)      
          READ(LEAUX,strFmt,ERR=9000) IN,IBC,IBT,ICHP,ICHPT,IQQP,
     ;                     IQQPT,IALF,IALFT,ICON,ICONT,IDMT,ICLK
C 1200     FORMAT(I<4+IFmt>,12I5)
...
C------------------------- Interpolates zone numbers
          ...
          IF (I.NE.IN)
     ;       CALL INTERP_NZNUM 
     ;(   I          ,IFmt       ,IN         ,IOLD       ,INALF
     ;   ,INALFT     ,INCHP      ,INCHPT     ,INQQP      ,INQQPT
     ;   ,INCON      ,INCONT     ,INDMT      ,IOEQT      ,IOTRS
     ;   ,IORTS      ,NTDMT      ,NUMNP      ,INPWR      ,NPARNP
     ;   ,MAINF      ,IXPARNP    ,IBTCO      ,IBCOD      ,NZALF
     ;   ,NZCOE      ,NZCHP      ,NZQQP      ,INCLK      ,NZCLK)
